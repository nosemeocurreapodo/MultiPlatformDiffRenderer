...
TEST_F(CrossBackendTests, JPosePipelineComparison)
{
    ...
    for (int out_lvl = 0; out_lvl < jtra_cpu.levels(); ++out_lvl)
    {
        ...
        int in_lvl = out_lvl;
        {
            ...
            double r_error = RMSE(image_cpu, image_gl, out_lvl);
    ...
    for (int out_lvl = 0; out_lvl < jmap_cpu.levels(); ++out_lvl)
    {
        ...
        int in_lvl = out_lvl;
        {
            ...
            jpose_renderer_cpu.Render(mesh_cpu,
                                      ...
                                      in_lvl, out_lvl,
                                      kf_cpu, dfdxy_cpu, 
                                      image_cpu, jmap_cpu, jexp_cpu, pids_cpu);
            acc_cpu_time += timer_.Stop();
            ...
            jpose_renderer_gl.Render(mesh_gl,
                                     ...
                                     in_lvl, out_lvl,
                                     kf_gl, dfdxy_gl, 
                                     image_gl, jmap_gl, jexp_gl, pids_gl);
            acc_gl_time += timer_.Stop();
    ...
    for (int out_lvl = 0; out_lvl < jmap_cpu.levels(); ++out_lvl)
    {
        ...
        int in_lvl = out_lvl;
        {
            ...
            jpose_renderer_cpu.Render(mesh_cpu,
                                      ...
                                      in_lvl, out_lvl,
                                      kf_cpu, dfdxy_cpu, 
                                      image_cpu, jtra_cpu, jrot_cpu, jexp_cpu, jmap_cpu, pids_cpu);
            acc_cpu_time += timer_.Stop();
            ...
            jpose_renderer_gl.Render(mesh_gl,
                                     ...
                                     in_lvl, out_lvl,
                                     kf_gl, dfdxy_gl, 
                                     image_gl, jtra_gl, jrot_gl, jexp_gl, jmap_gl, pids_gl);
            acc_gl_time += timer_.Stop();
