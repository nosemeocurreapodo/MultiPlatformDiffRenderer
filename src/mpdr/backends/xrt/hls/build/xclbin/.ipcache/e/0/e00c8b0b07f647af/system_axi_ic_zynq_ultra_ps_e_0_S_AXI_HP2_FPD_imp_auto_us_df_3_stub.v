...
//               system_axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD_imp_auto_us_df_3_stub.v
...
(* CHECK_LICENSE_TYPE = "system_axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD_imp_auto_us_df_3,axi_dwidth_converter_v2_1_33_top,{}" *) (* CORE_GENERATION_INFO = "system_axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD_imp_auto_us_df_3,axi_dwidth_converter_v2_1_33_top,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_dwidth_converter,x_ipVersion=2.1,x_ipCoreRevision=33,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynquplus,C_AXI_PROTOCOL=0,C_S_AXI_ID_WIDTH=1,C_SUPPORTS_ID=1,C_AXI_ADDR_WIDTH=64,C_S_AXI_DATA_WIDTH=32,C_M_AXI_DATA_WIDTH=128,C_AXI_SUPPORTS_WRITE=0,C_AXI_SUPPORTS_READ=1,C_FIFO_MODE=1,C_S_AXI_ACLK_RATIO=1,C_M_AXI_ACLK_RATIO=2,C_AXI_IS_ACLK_ASYNC=0,C_MAX_SPLIT_BEATS=16,C_PACKING_LEVEL=1,C_SYNCHRONIZER_STAGE=3}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
