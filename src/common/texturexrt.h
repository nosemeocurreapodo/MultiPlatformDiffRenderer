...
public:
TextureXRT() : nodata_(0), width_(0), height_(0), channels_(0)
    {
    ...
    TextureXRT(int width, int height, int channels, Type nodata_value)
    {
        if (channels > 4)
    ...
    TextureXRT(const TextureXRT &other)
    {
    ...
    TextureXRT &operator=(const TextureXRT &other)
    {
        if (this != &other)
        {
