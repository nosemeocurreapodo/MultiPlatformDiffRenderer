...
public:
    ...
    {
        this->kernel_ = xrt::kernel(device_xrt, uuid_xrt, "DepthRenderHLS");
    }
                ...
                TextureXRT<float> &depth_texture)
    {
        ...
        xrt::run run = this->kernel_(mesh.pos_buffer_.bo_, mesh.tex_buffer_.bo_, mesh.wei_buffer_.bo_, mesh.ebo_buffer_.bo_,
