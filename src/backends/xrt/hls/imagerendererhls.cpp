...
extern "C"
{
    void ImageRenderHLS(Scalar *pos_buffer_data,
                        Scalar *tex_buffer_data,
                        Scalar *wei_buffer_data,
                        UInt *ebo_buffer_data,
                        Scalar *in_texture_data,
                        ...
                        UInt in_texture_size,
                        Scalar in_nodata_value,
                        UInt in_lvl,
...
#pragma HLS INTERFACE m_axi port = out_texture_data bundle = gmem0
        ...
        TextureHLS<Scalar> in_texture(in_texture_width, in_texture_height, in_texture_size, in_nodata_value, in_texture_data);
