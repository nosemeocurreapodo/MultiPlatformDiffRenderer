...
#pragma HLS INTERFACE m_axi port = didxy_texture_data_ch1 bundle = gmem5
#pragma HLS INTERFACE m_axi port = didxy_texture_data_ch2 bundle = gmem6
#pragma HLS INTERFACE m_axi port = didxy_texture_data_ch3 bundle = gmem7
#pragma HLS INTERFACE m_axi port = didxy_texture_data_ch4 bundle = gmem8
#pragma HLS INTERFACE m_axi port = image_texture_data bundle = gmem9
#pragma HLS INTERFACE m_axi port = depth_texture_data bundle = gmem10
#pragma HLS INTERFACE m_axi port = jtra_texture_data bundle = gmem11
#pragma HLS INTERFACE m_axi port = jrot_texture_data bundle = gmem12
#pragma HLS INTERFACE m_axi port = jmap_texture_data bundle = gmem13
#pragma HLS INTERFACE m_axi port = pids_texture_data bundle = gmem14
        ...
        TextureRAM<ImageType> f_texture_ch1(f_texture_width, f_texture_height, f_nodata_value, f_texture_data_ch1);
        TextureRAM<ImageType> f_texture_ch2(f_texture_width, f_texture_height, f_nodata_value, f_texture_data_ch2);
        TextureRAM<ImageType> f_texture_ch3(f_texture_width, f_texture_height, f_nodata_value, f_texture_data_ch3);
        TextureRAM<ImageType> f_texture_ch4(f_texture_width, f_texture_height, f_nodata_value, f_texture_data_ch4);

        TextureRAM<linalg::Vec3<float>> didxy_texture_ch1(didxy_texture_width, didxy_texture_height, didxy_nodata_value, didxy_texture_data_ch1);
        TextureRAM<linalg::Vec3<float>> didxy_texture_ch2(didxy_texture_width, didxy_texture_height, didxy_nodata_value, didxy_texture_data_ch2);
        TextureRAM<linalg::Vec3<float>> didxy_texture_ch3(didxy_texture_width, didxy_texture_height, didxy_nodata_value, didxy_texture_data_ch3);
        TextureRAM<linalg::Vec3<float>> didxy_texture_ch4(didxy_texture_width, didxy_texture_height, didxy_nodata_value, didxy_texture_data_ch4);

        TextureRAM<ImageType> image_texture(out_texture_width, out_texture_height, image_nodata_value, image_texture_data);
        ...
        TextureRAM<linalg::Vec3<PidType>> pids_texture(out_texture_width, out_texture_height, pids_nodata_value, pids_texture_data);

        DiffRendererHLS renderer;
        renderer.Render(mesh, pose, cam, f_lvl, out_lvl,
                        f_texture_ch1, f_texture_ch2, f_texture_ch3, f_texture_ch4,
                        didxy_texture_ch1, didxy_texture_ch2, didxy_texture_ch3, didxy_texture_ch4,
